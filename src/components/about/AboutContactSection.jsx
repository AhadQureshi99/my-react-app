    ...
    <section className="py-20 md:py-28 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            {/* Row 3: Who to Call & Available Slots */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <select
                name="contactPerson"
              ...
              <input
                type="text"
                name="availableSlots"
                placeholder="Available Slots (e.g., Mon 2pm, Tue 10am)"
      ...
      <PopupModal
        ...
        prefill={{
          ...
          customAnswers: {
            a1: formData.serviceType,
            a2: formData.budget,
            a3: formData.contactPerson,
            a4: formData.availableSlots,
            a5: formData.note,
          },
        }}
      />
